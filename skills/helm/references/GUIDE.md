...
This guide provides comprehensive documentation for the **helm** skill in the custom-plugin-kubernetes plugin.
...
```bash
# Invoke the skill
claude "helm - [your task description]"

# Example
claude "helm - analyze the current implementation"
```
...
def implement_helm(input_data):
    """
    Implement helm functionality.
