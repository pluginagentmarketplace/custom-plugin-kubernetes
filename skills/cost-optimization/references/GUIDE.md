...
This guide provides comprehensive documentation for the **cost-optimization** skill in the custom-plugin-kubernetes plugin.
...
```bash
# Invoke the skill
claude "cost-optimization - [your task description]"

# Example
claude "cost-optimization - analyze the current implementation"
```
...
def implement_cost_optimization(input_data):
    """
    Implement cost-optimization functionality.
