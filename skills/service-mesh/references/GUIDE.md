...
This guide provides comprehensive documentation for the **service-mesh** skill in the custom-plugin-kubernetes plugin.
...
```bash
# Invoke the skill
claude "service-mesh - [your task description]"

# Example
claude "service-mesh - analyze the current implementation"
```
...
def implement_service_mesh(input_data):
    """
