...
This guide provides comprehensive documentation for the **troubleshooting** skill in the custom-plugin-kubernetes plugin.
...
```bash
# Invoke the skill
claude "troubleshooting - [your task description]"

# Example
claude "troubleshooting - analyze the current implementation"
```
...
def implement_troubleshooting(input_data):
    """
    Implement troubleshooting functionality.
