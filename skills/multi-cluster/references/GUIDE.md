...
This guide provides comprehensive documentation for the **multi-cluster** skill in the custom-plugin-kubernetes plugin.
...
```bash
# Invoke the skill
claude "multi-cluster - [your task description]"

# Example
claude "multi-cluster - analyze the current implementation"
```
...
def implement_multi_cluster(input_data):
    """
    Implement multi-cluster functionality.
